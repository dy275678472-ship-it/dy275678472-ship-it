...
def _genre_overflow_pads(case: dict) -> list[str]:
    ...
    pools = {
        ...
        "warrior": [
            ...
            f"他关上门，确认《{title}》相关的钥匙还在原处——安全感有时只是一把还能打开的锁。",
        ...
        "system": [
            ...
            f"有人要他表态。{name}只亮手续与时间表，不亮情绪。",
            f"{name}把「{hook}」写成可执行的半页纸：目标、路径、停损。写完才睡。",
            f"键帽缝里的纸屑被风吹起。{name}拈起扔掉，像丢掉一件不该留的杂讯。",
            f"他锁上笔记本，确认《{title}》相关的备份还在原处——安全感有时只是一份还能对上的校验。",
        ...
        "xianxia": [
            ...
            f"茶凉了半盏。{name}把与「{hook}」有关的争执改约到有第三人的药庐。",
        ...
        "game": [
            ...
            f"有人要他表态。{name}只亮手续与时间表，不亮情绪。",
            f"{name}把「{hook}」写成可执行的半页纸：目标、路径、停损。写完才睡。",
            f"路边纸屑被风卷起。{name}拈起扔掉，像丢掉一件不该留的杂讯。",
            f"他关上门，确认《{title}》相关的钥匙还在原处——安全感有时只是一把还能打开的锁。",
            f"{name}把「{hook}」从动态草稿撤下：能办成的事，不必先喊给全服听。",
        ...
        "history": [
            ...
            f"茶凉了半盏。{name}把与「{hook}」有关的争执改约到有第三人的值房。",
        ...
        "palace": [
            ...
            f"茶凉了半盏。{name}把与「{hook}」有关的争执改约到有第三人的膳房账后。",
        ...
        "scifi": [
            ...
            f"他关上门，确认《{title}》相关的密钥还在原处——安全感有时只是一枚还能验证的钥。",
    ...
    default = [
        ...
        f"有人要他表态。{name}只亮手续与时间表，不亮情绪。",
        f"{name}把「{hook}」写成可执行的半页纸：目标、路径、停损。写完才睡。",
        f"巷口纸片被风卷起。{name}弯腰捡起，像捡回一件不该丢的小事。",
        f"他关上门，确认《{title}》相关的钥匙还在原处——安全感有时只是一把还能打开的锁。",
