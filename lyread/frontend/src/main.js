...
const routes = [
  ...
  { path: '/workspace', component: () => import('./views/Placeholder.vue'), meta: { title: '创作台 - LyRead AI', desc: '小说创作控制台。' }},
  { path: '/reader', component: () => import('./views/Placeholder.vue'), meta: { title: '长篇小说 - LyRead AI', desc: '开始你的长篇小说创作。' }},
  { path: '/story', component: () => import('./views/Placeholder.vue'), meta: { title: '短故事 - LyRead AI', desc: '快速生成完整短故事。' }},
  { path: '/trending', component: () => import('./views/Placeholder.vue'), meta: { title: '案例阅读 - LyRead AI', desc: '浏览平台生成案例。' }},
]
