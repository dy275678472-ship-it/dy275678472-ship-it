...
CASES = [
    {
        ...
        "process": "cases/case-aviation-mask-process.jpg",
        "metrics": [
            "量程验证点：0.5–101 kPa 方向关键点联调通过",
            "交付物：样件 + 联调记录 + 面罩集成检查单",
            "节点：需求澄清 → 试制 → 联调 → 小批建议",
        ],
    ...
    },
    {
        ...
        "process": "cases/case-industrial-monitoring-process.jpg",
        "metrics": [
            "测点：不锈钢工艺管路在线氧分压监测",
            "验收：按公开精度分档完成目标工况抽检并归档",
            "配套：KD0100-02S-T1 + KD0100-03",
        ],
    ...
    },
    {
        ...
        "process": "cases/case-pin-integration-process.jpg",
        "metrics": [
            "探头重量目标：≦5 g 样机集成达成",
            "公差：插针尺寸公差 ≦0.5 mm",
            "效果：减少柜内线束整理工时（产线反馈）",
    ...
    },
    {
        ...
        "metrics": [
            "状态：评估进行中（非车规量产认定）",
            "产出：SCR/OBD 需求对表 + 台架验证大纲",
            "边界：官网通用规格 ≠ 自动具备某一车型量产认可",
        ],
